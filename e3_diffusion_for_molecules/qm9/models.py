...
def get_model(args, device, dataset_info, dataloader_train, canonicalizer = None):
    ...
    if args.probabilistic_model == 'diffusion':
        vdm = EnVariationalDiffusion(
            ...
            double_canon=args.double_canon
            )
